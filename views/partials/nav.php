                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <?php else : ?>
                                ...
                                <a href="/login" class="<?= urlIs("/login") ? "bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" : "text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium"; ?>">Log in</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php if($_SESSION["user"] ?? false) : ?>
                    <div class="relative ml-3">
                        <form method="POST" action="/logout">
                            ...
                            <button href="/logout" class="<?= urlIs("/logout") ? "bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" : "text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium"; ?>">Log out</button>
                        </form>
                    </div>
                    <?php endif; ?>
                </div>
